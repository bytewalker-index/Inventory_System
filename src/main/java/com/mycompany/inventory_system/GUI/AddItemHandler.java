 ...
 * @author admin
 */
public class AddItemHandler extends javax.swing.JFrame {

    /**
     * Creates new form AddItemHandler
     */
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(23, 21, 59));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddItemHandler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddItemHandler().setVisible(true);
            }
        });
    }
